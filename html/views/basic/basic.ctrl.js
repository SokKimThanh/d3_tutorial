var basic_ctrl = function($scope, d3service,$timeout) {
  ...
  var svgCircle = div_d3_ctrl
    .select("svg")
    .attr("width", 50)
    .attr("height", 50);
  var svgRectangle = div_d3_ctrl
    .select("svg#two")
    .attr("width", 50)
    .attr("height", 50);
  var svgEllipse = div_d3_ctrl
    .select("svg#three")
    .attr("width", 50)
    .attr("height", 50);
  var svgLine = div_d3_ctrl
    .select("svg#four")
    .attr("width", 100)
    .attr("height", 50);
  ...
  /* changing logo */ let span = d3.select("span.w3-bar-item.w3-right");
